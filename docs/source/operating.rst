[myfirsttssproject2-28fb] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myfirsttssproject2-28fb] container is NOT running**.

.. tip::
   You must have your [myfirsttssproject2-28fb] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/carterd132/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/carterd132/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46809  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='carterd132'  \-\-env DOCKERUSERNAME='carterd132@gmail.com'  \-\-env MQTTUSERNAME='carterd132@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   carterd132@gmail.com/myfirsttssproject2-28fb-amd64 (https://hub.docker.com/r/carterd132@gmail.com/myfirsttssproject2-28fb-amd64)
...
.. important::
   docker run -d -p 37797:37797 -p 45091:45091 -p 52075:52075 \-\-env TSS=0 \-\-env SOLUTIONNAME=myfirsttssproject2-28fb \-\-env SOLUTIONDAG=solution_preprocessing_dag-myfirsttssproject2-28fb \-\-env GITUSERNAME=carterd132  \-\-env GITREPOURL=https://github.com/carterd132/raspberrypi \-\-env SOLUTIONEXTERNALPORT=37797  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=45091  \-\-env SOLUTIONVIPERVIZPORT=52075 \-\-env DOCKERUSERNAME='carterd132@gmail.com'  \-\-env EXTERNALPORT=46809 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='carterd132@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  carterd132@gmail.com/myfirsttssproject2-28fb-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=52075
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=37797
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - carterd132@gmail.com/myfirsttssproject2-28fb-amd64
...
It can be accessed by entering: http://localhost:45091
...
.. important::
   http://localhost:52075/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:52075/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:52075/<html file>
...
[myfirsttssproject2-28fb] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/carterd132/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myfirsttssproject2-28fb
...
.. important::
   https://myfirsttssproject2-28fb.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myfirsttssproject2-28fb
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=37797, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39581, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39443, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39699, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38623, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37763, HPDEHOST=127.0.1.1, HPDEPORT=35755, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39353

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9825-myfirsttssproject2-28fb,solution_preprocessing_dag-myfirsttssproject2-28fb, python-preprocess-4337-myfirsttssproject2-28fb,solution_preprocessing_dag-myfirsttssproject2-28fb, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
